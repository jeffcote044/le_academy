<x-app-layout>
    ...
    <section class="pb-12 pt-16 bg-gray-100">
        <div class="container md:mb-8">
            <div class="flex flex-col-reverse md:flex-row items-center max-w-3xl mx-auto shadow-2xl p-8 rounded-lg bg-gray-50 mb-24">
                <div class="flex-1 pr-6 mt-4 md:mt-0 text-center md:text-left">
                    <p class="text-xl  md:text-2xl leading-tight mb-4">Ya está disponible el curso de <strong> {{$course->title}}</strong></p>
                    <a href="{{route('payment.oferta', $course)}}" target="_blank" class="bg-accent-400 py-2 px-4 text-lg md:text-xl font-bold rounded-full text-white inline-block border-2 border-accent-400 hover:bg-gray-50 hover:text-accent-400">¡Sí, quiero el curso!</a>
                </div>
